...
public class Pref {
  ...
  public static final String KEY_AIRPLAY_PHONE_VOLUME_SYNC = "airplay_phone_volume_sync";
  public static final String KEY_AIRPLAY_MUTE_PHONE_SPEAKER = "airplay_mute_phone_speaker";
  ...
  public static boolean getAirPlayAppleReceiver() {
    if (BuildConfig.ANDROID2APPLE4MUSIC_ONLY) return true;
    return getBoolean(KEY_AIRPLAY_APPLE_RECEIVER, true);
  }

  public static boolean getAirPlay1Mode() {
    if (BuildConfig.ANDROID2APPLE4MUSIC_ONLY) return false;
    return getBoolean(KEY_AIRPLAY1_MODE, false);
  }

  public static boolean getAirPlayPhoneVolumeSync() {
    return getBoolean(KEY_AIRPLAY_PHONE_VOLUME_SYNC, true);
  }

  public static void setAirPlayPhoneVolumeSync(boolean enabled) {
    SharedPreferences preferences = getPreferences();
    if (preferences != null) {
      preferences.edit().putBoolean(KEY_AIRPLAY_PHONE_VOLUME_SYNC, enabled).apply();
    }
  }

  public static boolean getAirPlayMutePhoneSpeaker() {
    return getBoolean(KEY_AIRPLAY_MUTE_PHONE_SPEAKER, true);
  }

  public static void setAirPlayMutePhoneSpeaker(boolean enabled) {
    SharedPreferences preferences = getPreferences();
    if (preferences != null) {
      preferences.edit().putBoolean(KEY_AIRPLAY_MUTE_PHONE_SPEAKER, enabled).apply();
    }
  }
